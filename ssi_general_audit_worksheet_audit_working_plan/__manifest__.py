...
{
    "name": "General Audit Worksheet - Audit Working Plan",
    "version": "14.0.1.1.0",
    ...
    "data": [
        ...
        "security/res_group/general_audit_ws_cbbbaf4.xml",
        "security/ir_model_access/general_audit_ws_cbbbaf4.xml",
        "security/ir_rule/general_audit_ws_cbbbaf4.xml",
        "data/ir_sequence/general_audit_ws_cbbbaf4.xml",
        "data/sequence_template/general_audit_ws_cbbbaf4.xml",
