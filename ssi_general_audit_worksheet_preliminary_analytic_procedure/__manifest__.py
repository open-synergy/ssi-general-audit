...
# pylint: disable=locally-disabled, manifest-required-author
{
    ...
    "data": [
        ...
        "data/master/general_audit_ws_c8740d4_item.xml",
        "views/analytic_procedure_conclusion_category_views.xml",
        "views/general_audit_ws_b32655a_views.xml",
        "views/ga_c8740d4/general_audit_ws_c8740d4_views.xml",
        "views/ga_c8740d4/general_audit_ws_c8740d4_item_views.xml",
