...
from . import (
    general_audit_ws_ae11f7e_related_party,
    general_audit_ws_ae11f7e_other_investment,
    general_audit_ws_ae11f7e_primary_funding,
    general_audit_ws_ae11f7e_customer,
    general_audit_ws_ae11f7e_supplier,
    general_audit_ws_ae11f7e_competitor,
    general_audit_ws_ae11f7e_accounting_policy,
